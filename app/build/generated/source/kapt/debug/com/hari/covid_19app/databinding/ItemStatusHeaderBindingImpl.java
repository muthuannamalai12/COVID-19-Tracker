...
public class ItemStatusHeaderBindingImpl extends ItemStatusHeaderBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_state_name, 1);
        sViewsWithIds.put(R.id.text_confirmed, 2);
        sViewsWithIds.put(R.id.text_active, 3);
        sViewsWithIds.put(R.id.text_recovered, 4);
        sViewsWithIds.put(R.id.text_deaths, 5);
    }
    // views
    @NonNull
