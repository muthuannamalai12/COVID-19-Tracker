...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.hari.covid_19app.R.layout.app_bar_main});
    ...
    private ActivityMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.hari.covid_19app.databinding.AppBarMainBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeAppBarMain((com.hari.covid_19app.databinding.AppBarMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeAppBarMain(com.hari.covid_19app.databinding.AppBarMainBinding AppBarMain, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
