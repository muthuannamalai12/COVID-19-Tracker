...
public abstract class Hilt_PreventionsFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PreventionsFragment() {
    super();
  }

  Hilt_PreventionsFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((PreventionsFragment_GeneratedInjector) generatedComponent()).injectPreventionsFragment(UnsafeCasts.<PreventionsFragment>unsafeCast(this));
  }
