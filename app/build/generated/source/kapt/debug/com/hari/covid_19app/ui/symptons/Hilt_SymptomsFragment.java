...
public abstract class Hilt_SymptomsFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_SymptomsFragment() {
    super();
  }

  Hilt_SymptomsFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((SymptomsFragment_GeneratedInjector) generatedComponent()).injectSymptomsFragment(UnsafeCasts.<SymptomsFragment>unsafeCast(this));
  }
