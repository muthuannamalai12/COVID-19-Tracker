...
public abstract class Hilt_PopularQuestionFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PopularQuestionFragment() {
    super();
  }

  Hilt_PopularQuestionFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((PopularQuestionFragment_GeneratedInjector) generatedComponent()).injectPopularQuestionFragment(UnsafeCasts.<PopularQuestionFragment>unsafeCast(this));
  }
